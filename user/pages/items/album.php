<div class="container-fluid box" id="album">
  <div class="row">
    <?php
    ...
    while ($data = mysqli_fetch_array($sql)) {
      ...
      echo "          <div class='h5 mb-0 font-weight-bold text-gray-800'>" . $album . "</div>";
      echo "        </div>";
      echo "        <div class='col-auto'>";
      echo "          <a onclick='albumsongs()'><img class='gambaralbum' src='../assets/album/" . "xx" . "' alt='' srcset=''></a>";
      echo "        </div>";
      echo "      </div>";
      echo "    </div>";
      echo "  </div>";
